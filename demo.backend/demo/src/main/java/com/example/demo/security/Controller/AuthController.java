...
import com.example.demo.security.Service.RollService;
...
public class AuthController {
    ...
    public ResponseEntity<?> nuevo(@RequestBody NuevoUsuario nuevoUsuario, BindingResult bindingResult){
        ...
        roles.add(rolService.getByRolNombre(RollNombre.ROLE_USER).get());
        
        if(nuevoUsuario.getRoles().contains("admin"))
            roles.add(rolService.getByRolNombre(RollNombre.ROLE_ADMIN).get());
